...
def benchmark_all_eval(model, criterion, converter, opt, calculate_infer_time=False):
    ...
    eval_data_list = ['IIIT5k_3000', 'SVT', 'IC13_857', 'IC15_1811', 'SVTP', 'CUTE80']
    ...
    print(total_evaluation_data_number)
...
def test(opt):
    ...
    model.eval()
    with torch.no_grad():
        if opt.benchmark_all_eval:  # evaluation with 6 benchmark evaluation datasets
...
if __name__ == '__main__':
    ...
    parser.add_argument('--benchmark_all_eval', action='store_true', help='evaluate 6 benchmark evaluation datasets')
    ...
    parser.add_argument('--imgW', type=int, default=96, help='the width of the input image')
