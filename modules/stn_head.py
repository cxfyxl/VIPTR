...
# from .repvggblock import RepVGGBlock,repvgg_model_convert,hswish
...
# class repSTNHead(nn.Module):
#   def __init__(self, in_planes, num_ctrlpoints, activation='none'):
#     super(repSTNHead, self).__init__()
#
#     self.in_planes = in_planes
#     self.num_ctrlpoints = num_ctrlpoints
#     self.activation = activation
#     self.stn_convnet = nn.Sequential(
#                           RepVGGBlock(in_planes, 32,act=activation), # 32*64
#                           nn.MaxPool2d(kernel_size=2, stride=2),
#                           RepVGGBlock(32, 64,act=activation), # 16*32
#                           nn.MaxPool2d(kernel_size=2, stride=2),
#                           RepVGGBlock(64, 128,act=activation), # 8*16
#                           nn.MaxPool2d(kernel_size=2, stride=2),
#                           RepVGGBlock(128, 256,act=activation), # 4*8
#                           nn.MaxPool2d(kernel_size=2, stride=2),
#                           RepVGGBlock(256, 256,act=activation), # 2*4,
#                           nn.MaxPool2d(kernel_size=2, stride=2),
#                           RepVGGBlock(256, 256,act=activation)) # 1*2
#
#     self.stn_fc1 = nn.Sequential(
#                       nn.Linear(2*256, 512),
#                       nn.BatchNorm1d(512),
